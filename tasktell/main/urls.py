...
urlpatterns = [
    ...
    path('project-edit-tasks/<int:pk>/<int:id>/', TaskEditView.as_view(), name='edit task'),
    path('project-delete-tasks/<int:pk>/<int:id>/', TaskDeleteView.as_view(), name='delete task'),
